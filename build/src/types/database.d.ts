...
import { FromTable, RawQueryBindings, RawBuilderContract, RawQueryBuilderContract, ReferenceBuilderContract, InsertQueryBuilderContract, DatabaseQueryBuilderContract } from './querybuilder.js';
/**
...
export interface DialectContract {
    readonly name: 'mssql' | 'mysql' | 'oracledb' | 'postgres' | 'redshift' | 'sqlite3' | 'libsql' | 'better-sqlite3';
 ...
 * available dialects
 */
export type ConnectionConfig = SqliteConfig | LibSQLConfig | MysqlConfig | PostgreConfig | OracleConfig | RedshiftConfig | MssqlConfig;
/**
...
export interface ConnectionContract extends EventEmitter {
     ...
     * @see clientName
     */
    readonly dialectName: 'mssql' | 'mysql' | 'mysql2' | 'oracledb' | 'postgres' | 'redshift' | 'sqlite3' | 'libsql' | 'better-sqlite3';
    readonly clientName: 'mssql' | 'mysql' | 'mysql2' | 'oracledb' | 'postgres' | 'redshift' | 'sqlite3' | 'libsql' | 'better-sqlite3';
    /**
