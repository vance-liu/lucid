...
import { setup, getDb, resetTables, getMigrator, cleanup as cleanupTables, } from '../../test-helpers/index.js';
...
test.group('Migrator', (group) => {
    ...
    test('migrate database using schema files', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v1.ts', `
    ...
    test('do not migrate when schema up action fails', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v2.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class User extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/accounts_v2.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
    ...
    test('do not migrate when dryRun is true', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v3.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/accounts_v3.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('catch and report errors in dryRun', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v4.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/accounts_v4.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('do not migrate a schema file twice', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/accounts_v5.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    `);
        ...
        await migrator.run();
        await fs.create('database/migrations/users_v5.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    test('rollback database using schema files to a given batch', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v6.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        const migrator = getMigrator(db, app, { direction: 'up', connectionName: 'primary' });
        await migrator.run();
        await fs.create('database/migrations/accounts_v6.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('rollback database to the latest batch', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v7.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        const migrator = getMigrator(db, app, { direction: 'up', connectionName: 'primary' });
        await migrator.run();
        await fs.create('database/migrations/accounts_v7.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('rollback all down to batch 0', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v8.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        const migrator = getMigrator(db, app, { direction: 'up', connectionName: 'primary' });
        await migrator.run();
        await fs.create('database/migrations/accounts_v8.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('rollback database using schema files to a given step', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/0_users_v6.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/1_accounts_v6.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('negative numbers specified by the step option must rollback all the migrated files to the current batch', async ({ fs, assert, cleanup, }) => {
        const app = new AppFactory().create(fs.baseUrl, () => { });
        await app.init();
        const db = getDb();
        cleanup(() => db.manager.closeAll());
    ...
    `);
        await fs.create('database/migrations/2_roles_v6.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
    ...
    test('rollback multiple times must be a noop', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v9.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        const migrator = getMigrator(db, app, { direction: 'up', connectionName: 'primary' });
        await migrator.run();
        await fs.create('database/migrations/accounts_v9.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('do not rollback in dryRun', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v10.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        const migrator = getMigrator(db, app, { direction: 'up', connectionName: 'primary' });
        await migrator.run();
        await fs.create('database/migrations/accounts_v10.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('do not rollback when a schema file goes missing', async ({ fs, assert, cleanup }) => {
        ...
        cleanup(() => db.manager.closeAll());
        assert.plan(5);
        await fs.create('database/migrations/users_v11.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/accounts_v11.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    `);
        ...
        assert.equal(migrator1.error.message, 'Cannot perform rollback. Schema file "database/migrations/accounts_v11" is missing');
    });
    test('get list of migrated files', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v12.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/accounts_v12.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('skip upcoming migrations after failure', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v13.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/accounts_v13.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('use a natural sort to order files when configured', async ({ fs, assert, cleanup }) => {
        ...
        await fs.create('database/migrations/12_users.ts', `
    ...
    `);
        await fs.create('database/migrations/1_accounts.ts', `
      import { BaseSchema as Schema } from '../../../../../src/Schema'
      module.exports = class User extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('use a natural sort to order nested files when configured', async ({ fs, assert, cleanup, }) => {
        const app = new AppFactory().create(fs.baseUrl, () => { });
        await app.init();
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        ...
        await fs.create('database/migrations/1/12_users.ts', `
      import { BaseSchema as Schema } from '../../../../../src/Schema'
      module.exports = class User extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        await fs.create('database/migrations/12/1_accounts.ts', `
      import { BaseSchema as Schema } from '../../../../../src/Schema'
      module.exports = class User extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('raise exception when rollbacks in production are disabled', async ({ fs, assert, cleanup, }) => {
        const app = new AppFactory().create(fs.baseUrl, () => { });
        await app.init();
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        ...
        await fs.create('database/migrations/users_v14.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    `);
        ...
        await migrator.run();
        await fs.create('database/migrations/accounts_v14.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_accounts', (table) => {
    ...
    test('upgrade old migration file name to new', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v15.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    test('upgrade file names also in dryRun', async ({ fs, assert, cleanup }) => {
        ...
        const db = getDb();
        cleanup(() => db.manager.closeAll());
        await fs.create('database/migrations/users_v16.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
