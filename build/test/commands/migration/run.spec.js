...
test.group('migration:run', (group) => {
    ...
    test('run migrations from default directory', async ({ fs, assert }) => {
        await fs.create('database/migrations/run_cmd_users.ts', `
    ...
    test('do not execute migrations in dry-run', async ({ fs, assert }) => {
        await fs.create('database/migrations/run_cmd_users_v1.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class User extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    test('do not run migrations in production', async ({ fs, assert, cleanup }) => {
        ...
        await fs.create('database/migrations/run_cmd_users_v2.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class User extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    test('run migrations in production when --force flag is passed', async ({ fs, assert, cleanup, }) => {
        process.env.NODE_ENV = 'production';
        cleanup(() => {
            delete process.env.NODE_ENV;
        });
        await fs.create('database/migrations/run_cmd_users_v3.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
      export default class User extends Schema {
        public async up () {
          this.schema.createTable('schema_users', (table) => {
    ...
    test('run migrations with compact output should display one line', async ({ fs }) => {
        await fs.create('database/migrations/run_cmd_users_v4.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
    ...
    `);
        await fs.create('database/migrations/run_cmd_clients_v4.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
    ...
    test('run already migrated migrations with compact output should display one line', async ({ fs, }) => {
        await fs.create('database/migrations/run_cmd_users_v5.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
    ...
    `);
        await fs.create('database/migrations/run_cmd_clients_v5.ts', `
      import { BaseSchema as Schema } from '../../../../src/schema/main.js'
