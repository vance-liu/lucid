...
test.group('Db connection count check', (group) => {
    ...
    test('return error when failure threshold has been crossed', async ({ assert, cleanup: teardown, }) => {
        const config = {
            connection: 'primary',
    ...
    test('return warning when warning threshold has been crossed', async ({ assert, cleanup: teardown, }) => {
        const config = {
            connection: 'primary',
            connections: { primary: getConfig() },
        };
    ...
    test('return success when unable to compute connections count', async ({ assert, cleanup: teardown, }) => {
        const config = {
            connection: 'primary',
            connections: { primary: getConfig() },
        };
